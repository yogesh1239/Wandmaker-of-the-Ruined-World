...
4. Review the assembled file for cross-part consistency: one term per concept, names and pronouns matching `glossary.md`, the narrative/direct-thought tense distinction preserved across joins, smooth transitions, `---` scene breaks correct and not doubled at joins, illustrations preserved in place, no duplicated paragraphs at part boundaries, every part present, and every `[^N]` in the consolidated notes resolving. Never normalize a valid natural-tense immediate thought into past during assembly.
