...
Build the EPUB for volume $ARGUMENTS.

The commands, spine mapping, and gate list live in `core/guides/epub-build-spec.md`; this command orchestrates them and does not restate them.
